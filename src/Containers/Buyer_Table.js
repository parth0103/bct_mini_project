...
class table extends Component {
	...
	handleViewImages = async (images) => {
		...
		if (images) {
			this.setState({
				images: ["https://images.app.goo.gl/VrB3FxiVZJVGucMq9"],
			});
		}
	};
	handleClose1 = () => {
															...
															<DialogContentText id="alert-dialog-slide-description">
																{this.state.images.map(
																	(image) => (
																		<img
																			src={
																				"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQaOxvK8US-T8n_G-10KLM0SXcDTi9LIBNjYzuN2y5Sjpr0TAY5osehVwVYzpTdHHBkxzQ&usqp=CAU"
																			}
																			style={{
																				height: "300px",
																				width: "400px",
